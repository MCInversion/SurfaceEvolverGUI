...
private:
	...
	// global sums for volume-based redistribution
	double totalArea;
	double totalCurvatureSqWeightedArea;
	double totalInvCurvatureFuncSum;
	...
	double tanRedistCurvatureFunction(double& H);
...
public:
	...
	inline std::string totalTime() { return total_time_message; };
};
